...
namespace Signpdf.Models.Implements
{
    public class SignService : ISignService
    {
        public readonly string KEYSTORE = "Cert/SonVV.p12";
        public readonly char[] PASSWORD = "123".ToCharArray();
            ...
            Signature signature)
        {
            ...
            using (FileStream fs = new FileStream(dest, FileMode.Create))
            {
                ...
                Rectangle rect = new Rectangle((float)signature.X, (float)signature.Y, (float)signature.Width, (float)signature.Height);
                ...
                appearance
                    ...
                    .SetPageRect(rect)
                    .SetPageNumber((int)signature.Page);
